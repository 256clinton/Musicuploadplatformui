...
type Tab = 'overview' | 'tracks' | 'analytics' | 'earnings' | 'profile';
...
export function UserDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className="w-64 bg-gradient-to-b from-yellow-500 via-red-600 to-black text-white p-6 flex flex-col">
            ...
            <div>
              <div className="bg-white rounded-xl p-6 shadow-md mb-6">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="font-bold text-xl mb-2">Total Earnings</h3>
                    <p className="text-4xl font-bold text-green-600">{userStats.totalEarnings.toLocaleString()} UGX</p>
                  </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-md">
                <h3 className="font-bold text-xl mb-4">Earnings by Track</h3>
                {userTracks.filter(t => t.status === 'distributed').length === 0 ? (
                  <div className="text-center py-8 text-gray-500">
                  ...
                  <div className="space-y-4">
                    {userTracks.filter(t => t.status === 'distributed').map(track => (
                      <div key={track.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-semibold">{track.title}</p>
                            <p className="text-sm text-gray-600">{track.plays.toLocaleString()} plays</p>
                          </div>
                        </div>
                        <p className="font-bold text-green-600">{track.earnings}</p>
                      </div>
                    ))}
                  </div>
                )}
